...
function insertNewTwit(twitText, twitAuthor) {
  var twitContext = {text:twitText, author: twitAuthor};
  var twitTemplate = Handlebars.templates.newTwit(twitContext);

  var container = document.getElementsByClassName('twit-container'); //you need this, its gonna look like crap without it
  container[0].insertAdjacentHTML('beforeend', twitTemplate);
...
/***************************************************************************
 **
 ** You should not modify any of the code below. - OK lol
 **
 ***************************************************************************/
